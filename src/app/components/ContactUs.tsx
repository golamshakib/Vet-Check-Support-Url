  ...
  return (
    <div className="mb-16 bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 rounded-lg font-semibold transition-all transform hover:scale-105 active:scale-95 mb-4"
      >
        <svg
          className="w-5 h-5"
          fill="none"
      ...
      <a
        ...
        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-500 hover:to-green-600 rounded-lg font-semibold transition-all transform hover:scale-105 active:scale-95 mb-4"
      >
        <svg
          className="w-5 h-5"
          fill="none"
